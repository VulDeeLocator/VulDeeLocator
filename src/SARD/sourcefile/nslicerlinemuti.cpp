...
int main(int argc, char *argv[])
{
	...
	string filename=txt.substr(0,txt.find_last_of('.'));

	string funct,cname,fname;
	...
	ifstream data_val(argv[4]); //argv[4] 是 data-val.txt
	...
	for (int i = 0,inum=0; i < vvp.size(); ++i)
	{
		...
		cout<<"holefuncname: "<<holefuncname<<endl<<"funcname:"<<funcnamesub<<endl;
